...
For now, I have a minimal pre-commit, which test only the blank spaces at ends of lines, but not the forgotten.\edtext{D}{\Afootnote{C}}
\pend
\pstart
\lsection{b}
\pend
