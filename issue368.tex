...
\begin{Leftside}
\resumenumbering*
    \pstart\noindent left side left side left \edtext{222bla}{\Cfootnote{side 2}} left side left side left side left side left side left side left side left side left side left side. \textbf{A}\pend
\pausenumbering*
\end{Leftside}
\begin{Rightside}
\resumenumbering*
