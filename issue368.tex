...
\begin{Leftside}
\resumenumbering*
    \pstart\noindent left side left side left \edtext{bla}{\Cfootnote{side}} left side left side left side left side left side left side left side left side left side left side. \textbf{A}\pend
\pausenumbering*
\end{Leftside}
\begin{Rightside}
\resumenumbering*
    \pstart\noindent \edtext{blabla}{\Cfootnote{right}} right side right side right side right side right side right side right side right side right side right side right side right side right side right side right side right side right side \edtext{blablabla}{\Cfootnote{right}} side. \textbf{B}\pend
\pausenumbering*
\end{Rightside}
\end{pairs}
\Columns
