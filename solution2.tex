...
\newcommand{\edtikztext}[3]{%
  \showlemma{#1}%
  \ifcsundef{edtikzt@#3}{\csdef{edtikzt@#3}{}}{}%
  \global\expandafter\appto\csname edtikzt@#3\endcsname{\edtext{}{\lemma{#1}\xxref{tikz:#3}{tikz:#3}#2}}{}{}%
}
...
\node(O) at (0,0){};
\node(N) at (0,3){\edtikztext{Nord}{\Afootnote{Septentrion}}{N}};
\node(S) at (0,-3){\edtikztext{Sud}{\Afootnote{Midi}}{S}};

\node(E) at (3,0){\edtikztext{Est}{\Afootnote{Levant}}{O}};
\node(W) at (-3,0){\edtikztext{Ouest}{\Afootnote{Couchant}}{O}};
