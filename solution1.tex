...
\begin{document}
  ...
  \foreach \Node in \@eledtikzlines {%\y1=y-coord of the node
    \path let \p1=($ (\Node) $) in node at (0,\y1)[inner sep=0,outer sep=0,text width=\textwidth-\parindent]{\Node\hfill\Node};
  }
\end{tikzpicture}


\the\@eledtikzline\hfill main text\hfill \the\@eledtikzline\eeledtikzline

\the\@eledtikzline\hfill main text\hfill \the\@eledtikzline
