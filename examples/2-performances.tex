...
\usepackage[series={},nocritical,noend,nofamiliar,noreledsec,noledgroup]{reledmac}
...
\begin{itemize}
  ...
  \item\verb+noreledsec+, \emph{reledmac} provides \verb+\reledsection+, \verb+\reledsubsection+ and similar commands in order to use sectioning commands inside numbered texts and to associate critical notes to section header. This feature needs writing in new auxiliary files. If you do not need this feature, use \verb+noreledsec+.
