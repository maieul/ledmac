...
\date{}
\title{Using Lua\LaTeX\ to typeset RTL text with eledpar}
\maketitle
\begin{abstract}
This file provides an example on how to use  eledpar and Lua\LaTeX\ to typeset a right to left text with its translation on the facing page\footnote{The text was provided by Latechneuse on \url{http://tex.stackexchange.com/q/227837/7712}.}.  
