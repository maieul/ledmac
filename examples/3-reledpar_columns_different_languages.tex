...
We also used \verb+\reledchapter+, which implies that chapter titles are printed with accompanying line numbers. 
...
\beginnumbering
\pstart
\reledchapter{﻿המאמר השני}\ledleftnote{s}
\pend
\pstart
