...
\date{}
\begin{english}
\title{Parallel pages with notes called in right page but printed in left page}
\maketitle

\begin{abstract}
This file provides an example of calling familiar notes in parallel pages typesetting, with footmark on the right side but notes printed in the left side.

The notes of series \verb+A+ are called in the left side with \verb+footnoteAnomk+ and the footnote  mark in inserted in the right page with \verb+footnoteAmk+.
\end{abstract}
\end{english}
