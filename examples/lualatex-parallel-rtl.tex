...
\maketitle
\begin{abstract}
This files provides an example of use of eledpar + \LuaLaTeX to typesset an Right to Left text with its translation in parallel\footnote{The text was provided by Latechneuse on \url{http://tex.stackexchange.com/q/227837/7712}.}.  
