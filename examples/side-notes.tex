...
\maketitle
\begin{abstract}
This file provides example of side notes with eledmac. 
We use :
\begin{itemize}
...
Notes are in small size and italic. If there are more than one notes by line, there are separated by $ | $. The notes start at the level of the line they are called, and continue after.
\end{abstract}
\end{english}
