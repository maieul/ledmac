...
\usepackage[series={A,B,C},noend,noreledsec,noledgroup]{reledmac}
...
\beforeXnotes{\before} 			% And so, we configure reledmac.
...
\afterXrule{\after}				% And so, we configure reledmac.
