...
\usepackage[series={A},parapparatus,noeledsec,noledgroup]{reledmac}
\makeindex[name=test]
\usepackage{hyperref}
\begin{document}
\setcounter{page}{637}
...
ut, ultricies vel, semper in, velit. \edtext{Ut}{\Aendnote{A}\Afootnote{Et\edindex[test]{Et} \textit{A}}} porttitor. Praesent in
