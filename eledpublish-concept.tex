...
\newcommand{\save@notecontent}[4]{
  ...
  \patchcmd{\tag}{\no@expands}{}{}{}
	\directlua{ 
	 n:write("\extractline@#1|-\extractendline@#1| \tag".."  ]#3".."\noexpand\n")
	}
}
...
\begin{document}
        ...
        \beginnumbering
            ...
            \pstart
                \textbf{Left} side \edtext{test paragraph}{\Afootnote{content}\edtext{s}{\Afootnote{b}}}. Left side paragraph. Left side paragraph. Left side paragraph. Left side paragraph. Left side paragraph. Left side paragraph. Left side paragraph. 
            \pend
