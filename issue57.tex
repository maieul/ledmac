...
ΦΑΙΔ. Αὐτός, ὦ \edtext{}{\lemma{\textbf{lemma}}\Afootnote{\enspace A note}}Ἐχέκρατες.
...
ΦΑΙΔ. Τύχη τις αὐτῷ, ὦ Ἐχέκρατες, συνέβη· \edtext{ἔτυχεν}{\lemma{blablabla}\Cfootnote[nonum,nosep]{note with nonum+nosep}} γὰρ τῇ προτεραίᾳ τῆς δίκης ἡ πρύμνα ἐστεμμένη τοῦ πλοίου ὃ εἰς Δῆλον Ἀθηναῖοι πέμπουσιν.
...
\setcounter{pstart}{1}
\numberpstarttrue
    \pstart\newpara \label{scolio1}\edtext{}{\Afootnote{\textbf{\ref{scolio1}} Anote Anote \textit{Anote} Anote \textbf{Anote} Anote Anote}}\edtext{}{\Bfootnote{\textbf{\ref{scolio1}} Bnote Bnote Bnote Bnote Bnote}}scolio 1] testo \edtext{testo}{\lemma{\textit{prova C}}\Cfootnote{\textit{prova A}}} testo testo \textbf{testo} testo testo testo testo testo testo testo testo.\pend
