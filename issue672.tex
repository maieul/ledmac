...
\usepackage[sidenotesmarginpage,%Put the side notes on the margins of the page, and not on the margins of the column
  widthliketwocolumns,%
...
\linenumberLevenifblanktrue%Get line number also if we have a blank line
\linenumberRevenifblanktrue%Get line number also if we have a blank line


\linenummargin{inner}%For normal typesetting (not column)
\linenummarginColumns{left}
\linenumOnlyPagesForColumns{right}% Left column = only on right page, at the left of the column = inner

\linenummarginColumnsR{right}
\linenumOnlyPagesForColumnsR{left}% Right column = only on left page, at the right of the column = inner
