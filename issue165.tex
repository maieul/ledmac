...
\def\eled@sections@@{}
\def\eled@chapter#1#2#3#4{%
    \ifstrempty{#4}%
      {%
      \ifstrempty{#1}%
	    {\global\csdef{eled@sectionning@#3}{\let\edtext=\dummy@edtext\chapter{#2}}}
	    {\global\csdef{eled@sectionning@#3}{\let\edtext=\dummy@edtext\chapter[#1]{#2}}}
	  }%
	  {%
	  \ifstrempty{#1}%
	    {\global\csdef{eled@sectionning@#3}{\let\edtext=\dummy@edtext\chapter*{#2}}}
	    {\global\csdef{eled@sectionning@#3}{\let\edtext=\dummy@edtext\chapter*[#1]{#2}}}%Bug in LaTeX!
	  }%
	\listgadd{\eled@sections@@}{#3}%
	}
\def\eled@section#1#2#3#4{%
    \ifstrempty{#4}%
      {\ifstrempty{#1}%
	    {\global\csdef{eled@sectionning@#3}{\section{#2}}}%
	    {\global\csdef{eled@sectionning@#3}{\section[#1]{#2}}}%
	  }%
	  {\ifstrempty{#1}%
	    {\global\csdef{eled@sectionning@#3}{\section*{#2}}}%
	    {\global\csdef{eled@sectionning@#3}{\section*[#1]{#2}}}%Bug in LaTeX!
	  }
	\listgadd{\eled@sections@@}{#3}%
	}
\def\eled@subsection#1#2#3#4{%
    \ifstrempty{#4}%
      {\ifstrempty{#1}%
	    {\global\csdef{eled@sectionning@#3}{\subsection{#2}}}%
	    {\global\csdef{eled@sectionning@#3}{\subsection[#1]{#2}}}%
	  }%
	  {\ifstrempty{#1}%
	    {\global\csdef{eled@sectionning@#3}{\subsection*{#2}}}%
	    {\global\csdef{eled@sectionning@#3}{\subsection*[#1]{#2}}}%Bug in LaTeX!
	  }
	\listgadd{\eled@sections@@}{#3}%
	}
\def\eled@subsubsection#1#2#3#4{%
    \ifstrempty{#4}%
      {\ifstrempty{#1}%
	    {\global\csdef{eled@sectionning@#3}{\subsubsection{#2}}}%
	    {\global\csdef{eled@sectionning@#3}{\subsubsection[#1]{#2}}}%
	  }%
	  {\ifstrempty{#1}%
	    {\global\csdef{eled@sectionning@#3}{\subsubsection*{#2}}}%
	    {\global\csdef{eled@sectionning@#3}{\subsubsection*[#1]{#2}}}%Bug in LaTeX!
	  }
	\listgadd{\eled@sections@@}{#3}%
	}
