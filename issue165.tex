...
\def\print@ledsectionR{%
    ...
    \numdef{\temp@}{\l@dpscR-1}%
    s\xifinlist{\temp@}{\eled@sectionsR@@}{\@nobreaktrue}{\@nobreakfalse}%
...
\pstart
s\eledsection*{\edtext{xxx}{\Afootnote{yyyy}}\ledsidenote{chapter}}
\pend
\pstart
DI use s git to manage some package.
I would like to add a pre-commit hook, to check if I have forgotten
