...
\def\lsection#1{%
  ...
  \immediate\write\l@sec@out{%
    \string\l@section{\unexpanded{#1}}{\the\l@dnumpstartsL}
    }%
  }
\def\lsubsection#1{%
  #1%
  \immediate\write\l@sec@out{%
    \string\l@subsection{\unexpanded{#1}}{\the\l@dnumpstartsL}
    }%
  }
\def\lsubsubsection#1{%
  #1%
  \immediate\write\l@sec@out{%
    \string\l@subsubsection{\unexpanded{#1}}{\the\l@dnumpstartsL}
    }%
  }
...
\l@demptyd@ta
  ...
  \affixline@num
  \affixpstart@num
  \xifinlist{\the\l@dnumpstartsL}{\l@sections@@}%
     {\print@lsection}  
     {\print@line}
...
\def\print@lsection{%
    ...
    \csuse{l@section@\the\l@dnumpstartsL}\hspace{\paperwidth}{\new@line \l@dunhbox@line{\one@line}}%
    \vskip-\baselineskip%
}
